...
-(void)audioUnit{
    ...
    reverbDesc.componentSubType = kAudioUnitSubType_NBandEQ;
    ...
    OSStatus result = AudioUnitSetProperty (
        ioUnit,
        kAudioUnitProperty_PresentPreset,   // the property key 属性的key
        kAudioUnitScope_Output,             // the scope to set the property on 设置属性所在的scope
