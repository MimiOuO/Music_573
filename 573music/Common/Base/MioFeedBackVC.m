...
- (void)viewDidLoad {
    ...
    UILabel *title1 = [UILabel creatLabel:frame(Mar, NavH + 24, 100, 16) inView:self.view text:@"请选择分类" color:subColor boldSize:16 alignment:NSTextAlignmentLeft];
...
//        NSNumber * nums = btn.tag;
    ...
    UILabel *title2 = [UILabel creatLabel:frame(Mar, NavH + 152, 100, 16) inView:self.view text:@"反馈内容" color:subColor boldSize:16 alignment:NSTextAlignmentLeft];
    ...
    [_noteTextView setTextColor:subColor];
    ...
    _textNumberLabel.textColor = grayTextColor;
    ...
    _placeholder = [UILabel creatLabel:frame(22 + Mar, NavH + 188, KSW_Mar2 , 22) inView:self.view text:@"详细描述你的问题或建议，我们将及时跟进解决。" color:grayTextColor size:14];
