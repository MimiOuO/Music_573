...
//    }
    ...
    UILabel *title2 = [UILabel creatLabel:frame(Mar, NavH + 152 -140, 100, 16) inView:self.view text:@"反馈内容" color:color_text_one boldSize:16 alignment:NSTextAlignmentLeft];
    ...
    _noteTextBackgroudView.frame = CGRectMake(Mar, NavH + 176 -140, KSW_Mar2 , 220);
    
    //文本编辑框
    _noteTextView.frame = CGRectMake(Mar + 12, NavH + 183 -140, KSW_Mar2 - 20, 176);
    ...
    _placeholder = [UILabel creatLabel:frame(22 + Mar, NavH + 188 -140, KSW_Mar2 , 22) inView:self.view text:@"详细描述你的问题或建议，我们将及时跟进解决。" color:color_text_two size:14];
