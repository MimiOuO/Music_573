...
- (void)viewDidLoad {
    ...
    UIImageView *backImg = [UIImageView creatImgView:frame(Mar, StatusH + 10, 26, 26) inView:self.view image:@"left" radius:0];
    [backImg whenTapped:^{
...
- (void)setupQRCodeScan {
    ...
    //无权限
        ...
        [UIWindow showInfo:@"检测到您暂未开启相机权限，请到设置中打开相机权限再试"];
        [self.navigationController popViewControllerAnimated:YES];
        return;
