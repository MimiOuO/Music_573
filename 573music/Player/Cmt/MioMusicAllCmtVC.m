...
//#import "MioPersonPageVC.h"
@interface MioMusicAllCmtVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MioMusicAllCmtVC

- (void)viewDidLoad {
    [super viewDidLoad];
    [self.navView.leftButton setImage:backArrowIcon forState:UIControlStateNormal];
    [self.navView.centerButton setTitle:@"全部回复" forState:UIControlStateNormal];
    self.view.backgroundColor = appClearColor;
    self.view.frame = CGRectMake(0, - NavH, KSW, KSH);
...
- (void)setCmtModel:(MioCmtModel *)cmtModel{
    ...
    _replyTable = [[UITableView alloc] initWithFrame:CGRectMake(0, NavH, KSW, KSH - NavH)];
